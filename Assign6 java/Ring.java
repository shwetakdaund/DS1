...
public class Ring {
    ...
    int coordinator;
    boolean processes[];
    ArrayList<Integer> pid;                                         //extra

    public Ring(int max) {
        coordinator = max;
        max_processes = max;
        pid = new ArrayList<Integer>();                             //extra
    ...
    void displayArrayList(ArrayList<Integer> pid) {                     //new function
        System.out.print("[ ");
        for(Integer x : pid) {
            System.out.print(x + " ");
        }
    ...
    void initElection(int process_id) {                                 //new function
        if(processes[process_id-1]) {
            pid.add(process_id);
